<?php
	...
	if ($apiPathPrefix == "" || $courseID <= 0 || $apiPathEndpoint == "") {
		echo "Invalid values for API call in file: 'ajax-get-data.php'. Exiting.";
		exit;
	}
	...
	# END: LOCAL TESTING
		...
		while (!$finished) { // while not finished
			// set url
			curl_setopt($ch, CURLOPT_URL, TOOL_CONSUMER_URL . $apiPathPrefix . $courseID . $apiPathEndpoint . '&page=' . $page);

								...
								<div class="row col-sm-5 small">
									<div class="col-sm-12">
										...
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-9">
												<input type="text" id="edit_OpeningDateBegin" name="edit_OpeningDateBegin" class="form-inline wms-custom-datepicker" readonly maxlength="10" placeholder="mm/dd/yyyy" value="" />
											</div>
										</div>

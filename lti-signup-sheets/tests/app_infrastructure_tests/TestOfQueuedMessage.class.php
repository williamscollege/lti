<?php
	...
	class TestOfQueuedMessage extends WMSUnitTestCaseDB {
		...
		function testQueuedMessageDBInsertViaFactory() {
			...
			$qm = QueuedMessage::factory($this->DB, 50, 'jbond@institution.edu', '[Glow Signup Sheets] Signup cancelled for Sheet 602', 'Signup cancelled for Sheet 602 at 08/25/2015 10:01 PM', 703, 602);
			$qm->updateDb();

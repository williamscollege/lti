$(document).ready(function () {
	...
	$("#link_show_by_time_range").click(function () {
		$(this).hide();
		$("label[for='ajaxCalCreateOpeningBeginTimeHour']").html("Starting&nbsp;at");
	...
	$("#link_show_by_duration").click(function () {
		$(this).hide();
		$("label[for='ajaxCalCreateOpeningBeginTimeHour']").html("From");
		$(".link_show_by_duration").hide();
...
//	if ($(this).hasClass('openings_by_time_range')) {
//		$(this).removeClass('openings_by_time_range').addClass('openings_by_duration').prop('title', 'Switch to openings by duration').html('Switch to openings by duration');
//	}
//	else {
//		$(this).removeClass('openings_by_duration').addClass('openings_by_time_range').prop('title', 'Switch to openings by time range').html('Switch to openings by time range');
//	}
//
...
//});
	...
	$("#btn_save_openings").click(function (event) {
		...
		var btime = valsToTimeString($("#ajaxCalCreateOpeningBeginTimeHour").val(), $("#begintime_minute").val(), $("#begintime_ampm").val());

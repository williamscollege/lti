<?php
	...
	class Enrollment extends Db_Linked {
		public static $fields = array('enrollment_id', 'canvas_user_id', 'canvas_course_id', 'canvas_role_name', 'course_idstr', 'user_id', 'course_role_name', 'section_idstr', 'flag_delete');

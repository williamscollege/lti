<?php
	...
	class SUS_Access extends Db_Linked {
		...
		public static function createNewAccess($type,$forSheetId,$constraintId,$constraintData,$dbConnection) {
			$broadness = -1;
			switch ($type) {
				case 'adminbyuser': $broadness = 1; break;
				case 'byuser': $broadness = 10; break;
				case 'bycourse': $broadness = 20; break;
				case 'byinstr': $broadness = 30; break;
				case 'bydept': $broadness = 40; break;
				case 'bygradyear': $broadness = 50; break;
				case 'byrole': $broadness = 60; break;
				case 'byhasaccount': $broadness = 60; break;
			}

<?php
	...
	class Course extends Db_Linked {
		public static $fields = array('course_id', 'course_idstr', 'short_name', 'long_name', 'account_idstr', 'term_idstr', 'canvas_course_id', 'begins_at_str', 'ends_at_str', 'flag_delete');

<?php
	...
	$_SESSION['userdata']['username'] = "cph2"; //"mockUserJBond"; // TESTINGUSER; // "areinhar"; // "cpaquett", "jjtest", "mbernhar", TESTINGUSER; // $this->resource_link->getSetting('custom_canvas_user_login_id', '');"" // LTI form value

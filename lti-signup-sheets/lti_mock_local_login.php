<?php
	...
	$_SESSION['userdata']['username'] = "areinhar";// TESTINGUSER;// "areinhar", "zsb1", "jjtest", "mbernhar", TESTINGUSER; // $this->resource_link->getSetting('custom_canvas_user_login_id', '');"" // LTI form value

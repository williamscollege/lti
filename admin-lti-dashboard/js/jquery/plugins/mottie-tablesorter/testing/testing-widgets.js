...
jQuery(function ($) {
	...
	QUnit.test('Filter searches', function (assert) {
		...
		return QUnit.SequentialRunner(
			...
			function () {
				ts.setFilters(table, ['', 'c* && l && a'], true);
			},
			function () {
			...
			function () {
				ts.setFilters(table, ['', '', '', '>20 && <40'], true);
			},
			function () {
			...
			function () {
				ts.setFilters(table, ['', '', '', '<10 or >40'], true);
			},
			function () {
				assert.cacheCompare(table, 3, [51, 45, 65], 'search "<10 or >40"', true);
			}
		).nextTask(
			function () {
			...
			function () {
				ts.setFilters(table, ['', '/(Alex|Aar'], true);
			},
			function () {

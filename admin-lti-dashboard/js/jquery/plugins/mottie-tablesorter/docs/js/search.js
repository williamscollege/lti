...
jQuery.fn.highlight = function (a, c) {
	var b = {
		className: "highlight", element: "span", caseSensitive: !1, wordsOnly: !1, ignore: "", min: 3, error: ">= 3", message: function (a) {
...
(function (b) {
	...
	l.prototype = {
		show: function () {
			...
			if (a && this.enabled) {
				...
				}), f = c[0].offsetWidth, h = c[0].offsetHeight, e = "function" == typeof this.options.gravity ? this.options.gravity.call(this.$element[0]) : this.options.gravity, k;
				switch (e.charAt(0)) {
					case "n":
					...
					case "e":
						...
						break;
					case "w":
						k = {top: a.top + a.height / 2 - h / 2, left: a.left + a.width + this.options.offset}, g = {"border-right-color": d}
				}
	...
	b.fn.tipsy.autoBounds = function (a, c) {
		return function () {
			var d = c[0], f = 1 < c.length ? c[1] : !1, g = b(document).scrollTop() + a, h = b(document).scrollLeft() + a, e = b(this);
			e.offset().top < g && (d = "n");
			e.offset().left < h && (f = "w");

...
CREATE TABLE IF NOT EXISTS `dashboard_users` (
	...
	`flag_is_enrolled_course_adl` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
	`flag_is_enrolled_course_fft` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
	`flag_is_enrolled_course_oc` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
	...
	INDEX `flag_is_enrolled_course_adl` (`flag_is_enrolled_course_adl`),
	INDEX `flag_is_enrolled_course_fft` (`flag_is_enrolled_course_fft`),
	INDEX `flag_is_enrolled_course_oc` (`flag_is_enrolled_course_oc`),
